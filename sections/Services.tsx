...
export default function Services() {
  return (
    <section id="services" className="bg-[var(--surface)]">
      ...
      {/* Header */}
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 pt-28 sm:pt-36 lg:pt-48 pb-16 sm:pb-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
      ...
      <div className="flex flex-col">
        {services.map((service, i) => (
          ...
          >
            ...
            {/* Content */}
            <div
              className={`absolute inset-0 flex items-end px-8 sm:px-14 lg:px-20 pb-8 sm:pb-14 lg:pb-20 ${
