  ...
  return (
    <>
      ...
      <section className="relative min-h-[65vh] sm:min-h-screen flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto w-full px-5 sm:px-8 md:px-12 lg:px-20 pb-14 sm:pb-24 md:pb-32">
          <motion.div
      ...
      <div className="py-14 sm:py-20 bg-[var(--bg)] overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 mb-8 sm:mb-12">
          <motion.p
            initial={{ opacity: 0 }}
