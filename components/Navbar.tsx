...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 h-[80px] sm:h-[88px] flex items-center justify-between">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[var(--bg)] flex flex-col justify-between px-6 sm:px-10 pt-28 pb-12 md:hidden"
          >
