...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-8 sm:px-14 md:px-20 lg:px-28 h-[80px] sm:h-[88px] flex items-center justify-between">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[var(--bg)] flex flex-col justify-between px-8 sm:px-14 pt-28 pb-12 md:hidden"
          >
